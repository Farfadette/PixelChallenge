...
public class Player4Movement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        energyWave = GameObject.FindWithTag("EnergyWave4");
    ...
    private void Update()
    {
        ...
        if (Input.GetKey(KeyCode.Keypad8))
        {
            ...
            if (Input.GetKeyDown(KeyCode.Keypad8) && Time.time < doubleClickTime && Time.time > nextDash)
            {
	...
	private void mort()
	{
		Camera.main.GetComponent<Game_Manager>().Player4Death();
